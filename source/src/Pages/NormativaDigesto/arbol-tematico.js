                ...
                arboles.push(
                    <div>
                        <div className="tarjeta">{decode(raiz.tema)}
                            ...
                            <button className="btn btn-secondary btn-sm" onClick={(e) => buscarNormas(e, raiz.idTema)}>
            ...
            if (child.show) {
                nodos.push(<div style={{ paddingLeft: "2em" }}>
                    <div className="tarjeta">{child.tema}
                        ...
                        <button className="btn btn-secondary btn-sm" onClick={(e) => buscarNormas(e, child.idTema)}>
